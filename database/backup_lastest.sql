...
ALTER TABLE `account` 
ADD UNIQUE KEY `uk_identity_number` (`identity_number`);
...
-- Chèn cho Patient (ID = 1)
INSERT INTO `role` (`id`, `role_name`, `description`) 
VALUES (1, 'patient', 'This role is for the client/patient. They have the right to manage their personal information (patient profile), schedule new appointments, track their appointment status, and view examination/test results after the doctor completes the procedure.');

-- Chèn cho Doctor (ID = 2)
INSERT INTO `role` (`id`, `role_name`, `description`) 
VALUES (2, 'doctor', 'This role is for healthcare professionals (doctors). They have access to the assigned appointment list, updated test results, diagnoses, and medical notes. They also have access to basic patient information for use during examinations.');

-- Chèn cho Admin (ID = 3)
INSERT INTO `role` (`id`, `role_name`, `description`) 
VALUES (3, 'admin', 'Full Access.');

ALTER TABLE `account` 
ADD COLUMN `identity_number` VARCHAR(12) NOT NULL AFTER `username`;

ALTER TABLE `account` 
ADD COLUMN `role_id` INT NOT NULL AFTER `identity_number` ;
Alter table `account`
...
INSERT INTO `account` (`keycloak_user_id`, `username`, `identity_number`, `role_id`) VALUES
('9ce9d928-8f8b-4fb9-b932-053d6ed9ed9a', 'duongducanh06@gmail.com', '123456789001', 1),
('fe1c2929-8e3c-472e-9674-6898382dd99e', 'duongducanhcnnttcspbkhn@gmail.com', '123456789002', 1),
('c46a9ab0-d1eb-4e60-aa90-81ac62d79644', 'nguyentadung02@gmail.com', '123456789003', 1),
('9a84d48f-475a-405a-9189-855d75081e90', 'patient', '123456789004', 1),
('b20bfce6-f58c-4add-8cee-2c5a4eed4550', 'doctor2', '123456789005', 2),
('09106d39-e953-4f85-80f8-846abbd1132b', 'admin', '123456789123', 3);